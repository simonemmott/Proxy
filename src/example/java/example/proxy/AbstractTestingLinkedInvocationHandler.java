...
public abstract class AbstractTestingLinkedInvocationHandler<T> extends AbstractLinkedInvocationHandler<T> {

	private static Map<Class<? extends InvocationHandler>, Object> results = new HashMap<Class<? extends InvocationHandler>, Object>();
	
	public AbstractTestingLinkedInvocationHandler() {
		super();
	}
	public AbstractTestingLinkedInvocationHandler(Class<T> handlerForClass) {
		super(handlerForClass);
	}
